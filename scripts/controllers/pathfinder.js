...
$(document).ready(function () {
    ...
    jp.pathFinder = {
        ...
        findPath: function (xC, yC, xT, yT, maxSteps) {
            ...
            this.reset()
                .addOpen(new jp.Step(xC, yC, xT, yT, 0, false)); // Start node G = 0
            ...
            while (this.open.length !== 0) {
                ...
                for (i = 0; i < neighbors.length; i++) {
                    ...
                    var moveCostCalc = Math.sqrt(dx * dx + dy * dy);
                    var moveCost = Math.floor(moveCostCalc * 10) // / 10

                    stepCost = current.g + moveCost; // Cumulative cost
